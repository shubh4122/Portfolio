const BottomNav = () => {
    return(
        <div className="sticky bottom-1/40 w-full h-20 flex items-center justify-center ">
            <div className="bnav w-fit h-20 border border-white/10 bg-gray-800/30 backdrop-blur-xs rounded-2xl flex items-center justify-center gap-4">
                <a href={""} className="h-full w-14 " >
                ...
                <a href={"https://github.com/shubh4122"} target={"_blank"}  className="max-sm:hidden">
                ...
                <a href={`https://wa.me/917052800709?text=Hi Shubham, I came across your portfolio and wanted to connect.`} target={"_blank"} className="max-[490px]:hidden">
                    <img src="wa.png" className="hover:-translate-y-2 hover:scale-150 hover:rotate-4  h-16 w-16  grayscale-80 hover:grayscale-0 "/>
                </a>

                <a href={"https://x.com/shubh_twt"} target={"_blank"} className="max-sm:hidden" >
                ...
                <a href={"https://drive.google.com/file/d/1vhXVr9NZ_fSGU6ExyUxJO1K8UGyHdkDS/view?usp=sharing"} target={"_blank"}  className="hidden md:inline-block">
